   ...
   $.fn.pickList = function (options) {
      ...
      this.init = function () {
         var pickListHtml =
                 "<div class='row'>" +
                 "  <div class='col-sm-5'>" +
                 "	 <select class='form-control pickListSelect pickData' multiple name='mostafijar'></select>" +
                 " </div>" +
                 " <div class='col-sm-2 pickListButtons'>" +
                 "	<p  class='pAdd btn btn-primary btn-sm'>" + opts.add + "</p>" +
                 "	<p  class='pRemove btn btn-primary btn-sm'>" + opts.remove + "</p>" +
                 " </div>" +
                 " <div class='col-sm-5'>" +
                 "    <select class='form-control pickListSelect pickListResult' multiple name='mostafijar'></select>" +
                 " </div>" +
                 "</div>";
