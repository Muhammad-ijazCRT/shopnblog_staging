...
<button type="button" class="btn-menu-expand btn btn-primary btn-block mb-2 d-lg-none" type="button" data-toggle="collapse" data-target="#navbarUserHome" aria-controls="navbarCollapse" aria-expanded="false">
    ...
    <small class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ trans('general.account') }}</small>
		...
		@endif
			...
			<a href="{{url('my/subscriptions/welcomeMessage')}}" class="list-group-item list-group-item-action d-flex justify-content-between @if (request()->is('my/subscriptions/welcomeMessage')) active @endif">
					<div>
							<i class="feather icon-user-check mr-2"></i>
							<span>{{trans('users.welcome_message')}}</span>
					</div>
					<div>
							<i class="feather icon-chevron-right"></i>
					</div>
			</a>
			<a href="{{url('my/subscriptions/freebies')}}" class="list-group-item list-group-item-action d-flex justify-content-between @if (request()->is('my/subscriptions/freebies')) active @endif">
					<div>
							<i class="feather icon-user-check mr-2"></i>
							<span>{{trans('users.freebies')}}</span>
					</div>
					<div>
							<i class="feather icon-chevron-right"></i>
					</div>
			...
			@endif
					...
					<a href="{{url('my/purchased/items')}}" class="list-group-item list-group-item-action d-flex justify-content-between @if (request()->is('my/purchased/items')) active @endif">
							<div>
									...
									<span>{{trans('general.purchased_sh')}}</span>
							</div>
							<div>
									<i class="feather icon-chevron-right"></i>
							</div>
