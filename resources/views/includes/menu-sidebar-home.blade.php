	...
	@endif
		<li>
			<a href="{{ url('my/purchases') }}" @if (request()->is('my/purchases')) class="active disabled" @endif>
				...
				<span class="ml-2">{{ trans('general.purchaseds') }}</span>
			</a>
		</li>
		<li>
			<a href="{{ url('my/purchased/items') }}" @if (request()->is('my/purchased/items')) class="active disabled" @endif>
				<i class="bi bi-cart-check"></i>
				<span class="ml-2">{{ trans('general.purchased_sh') }}</span>
			</a>
		</li>
	<li>
		<a href="{{ url('messages') }}">
