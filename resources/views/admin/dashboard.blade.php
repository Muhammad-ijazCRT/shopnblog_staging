...
<div class="content">
	<div class="row">
		...
		<div class="col-lg-3 mb-3">
			<div class="card shadow-custom border-0 overflow-hidden">
				<div class="card-body">
					<h3><i class="bi-cash-stack me-2 icon-dashboard"></i> {{ Helper::amountFormatDecimal($total_raised_funds_moderator) }}</h3>
					<small>{{ trans('admin.earnings_moderator_admin') }}</small>
