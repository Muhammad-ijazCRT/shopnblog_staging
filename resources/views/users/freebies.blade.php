...
@section('title') {{trans('users.freebies')}} -@endsection
    ...
    <div class="container">
      ...
      <div class="row justify-content-center text-center mb-sm">
        ...
        <div class="col-lg-8 py-5">
          ...
          <h2 class="mb-0 font-montserrat"><i class="feather icon-user-check mr-2"></i> {{trans('users.freebies')}}</h2>

          <p class="lead text-muted mt-0">{{trans('users.freebies_subtitle')}}</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
          ...
          <div class="my-5">
<span style="font-size:0.8rem;">{{trans('users.freebie_description')}}</span>
            ...
            <form action="{{url('message/send')}}" method="post" accept-charset="UTF-8" id="formSendMsg" enctype="multipart/form-data">
              ...
              <input type="hidden" id="id" value="{{ $freebies ? $freebies->id : '' }}" />
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="button" id="saveFreebiesBtn" class="btn btn-default text-white font-weight-bold" style="background:#03e592">Save</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#saveFreebiesBtn').on('click', function() {

            const welcomeMessage = $("#freebies").val();
