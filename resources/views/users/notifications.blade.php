        ...
        <?php
            ...
            case 6:
              ...
              case 16:
                ...
                case 18:
                $action          =   $key->productName. ' bought on '. date('Y-m-d',strtotime($key->date))  .'  has received a shipping update';
                $linkDestination = url('my/purchased/items');
                $text_link       = '(See Details)';
                break;
        		}
