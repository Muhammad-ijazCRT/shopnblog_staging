...
public static function resizeImageFixed($image,$width,$height,$imageNew = null)
{
 ...
 public static function calculateProductPriceOnStore($value, $shippingFee = 0.00, $spacial=0.00)
 {
	 $settings = AdminSettings::first();
	 ...
	 $value = ($value + $shippingFee+$spacial);
 ...
 public static function amountGrossProductShop($amount, $shippingFee = 0.00)
 {
  ...
  public static function spacial($id){
