    ...
    confirm: function(text, callback) {
		...
		thumbnails: {
			box: '<div class="fileuploader-items">' +
                      '<div class="fileuploader-items-list d-flex row">' +
					      '<div class="fileuploader-thumbnails-input col-3"><div class="fileuploader-thumbnails-input-inner"><i>+</i></div></div>' +
                      '</div>' +
                  '</div>',
			item:  '<div class="col-3 h-100">' +
                       ...
                       '<div class="input-group my-2">'+
                            ...
                            '</div>'+
                            '<input data-filename="${name}" class="form-control isNumber active price" autocomplete="off" name="price[]" placeholder="Price" type="text">'+
                        '</div>'+
                  '</div>',
			item2: '<li class="fileuploader-item">' +
                       ...
                       `<div class="input-group mb-2">
                            ...
                            <input class="form-control isNumber active" autocomplete="off" name="price" placeholder="Price" type="text">
                        </div>`+
                   '</li>',
